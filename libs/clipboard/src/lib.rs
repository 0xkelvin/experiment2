...
pub fn server_clip_file(
    ...
    match msg {
        ...
        ClipboardFile::MonitorReady => {
            log::info!("server_monitor_ready called");
            ret = server_monitor_ready(context, conn_id);
            log::info!("server_monitor_ready called, return {}", ret);
        }
...
extern "C" fn notify_callback(conn_id: UINT32, msg: *const NOTIFICATION_MESSAGE) -> UINT {
    log::info!("notify_callback called");
    let data = unsafe {
        let msg = &*msg;
...
extern "C" fn client_format_list(
    ...
    unsafe {
        ...
        while i < (*clip_format_list).numFormats {
            ...
            // log::info!("format list item {}: format id: {}, format name: {}", i, format_data.formatId, &format_name);
            i += 1;
        }
...
extern "C" fn client_format_data_response(
    ...
    log::info!("cconn_idlient_format_data_response called");
